...
## Recommendation
[Lead with the answer. One clear sentence. "Use X" or "Do Y" â€” not "It depends" as the opening.]

## Reasoning
[Why this recommendation is right for this stack and context. 2â€“4 paragraphs.]

## Tradeoffs
âœ… [Advantage 1]
âœ… [Advantage 2]
âš ï¸  [Limitation 1 â€” honest, not minimized]
âš ï¸  [Limitation 2]

## Alternatives Considered
**[Alternative A]** â€” why it wasn't recommended for this case
**[Alternative B]** â€” why it wasn't recommended for this case

## Related Considerations
[Adjacent concerns the questioner should be aware of â€” related agents to consult, follow-on decisions this one unlocks or constrains.]
...
- **Note adjacent agent handoffs.** If this decision touches another layer, flag it: "â†’ This affects how the Data agent sets up the schema."

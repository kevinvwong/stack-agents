...
Cross-cutting: "design tokens / dark mode / Tailwind config" → `[AGENT: cross-design-system]`
...
| `design-system` | agents/cross-design-system.md | Tokens, Tailwind, shadcn/ui, dark mode, theming                                                  |

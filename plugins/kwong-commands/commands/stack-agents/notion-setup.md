...
| `--databases <list>` | No | Comma-separated subset to create. Default: all canonical databases. Valid values: `projects,agents,sprints,prds,research,analytics,github-audits,quality-audits,game-design,runbooks` |
